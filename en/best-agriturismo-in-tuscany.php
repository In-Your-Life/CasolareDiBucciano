...
{
  	header("Location: http://m.casolaredibucciano.it/en/agriturismo_en.php");
   	die();
}
if (($_SERVER["HTTP_HOST"]=="www.casolaredibucciano.it") or ($_SERVER["HTTP_HOST"]=="casolaredibucciano.it")) {
	header("HTTP/1.1 301 Moved Permanently"); 
header("Location: http://www.casolaredibucciano.eu/en/best-agriturismo-in-tuscany.php");
...
<div id="header_1" style="background-image:url(../_ext/img/best_agriturismo_in_tuscany_100.jpg);">
...
<div id="titolo">
Agriturismo &raquo; ROOMS
</div>

The farmhouse  has 11 rooms en-suite bedrooms, the rooms have air conditioning and heating, LED TV and fridge.
<br/><br/>
The J-suite has been converted from a large barn, and has a private garden and a living area with a sofa and fireplace. It's ideal for those who want a bit of privacy or for those who, in winter, are looking for a cozy and warm place.
<br/><br/>
The triple room is situated on the ground floor, and has a small private garden with a private entrance.
<br/><br/>
On the ground floor we also have a double room, accessible for disabled people, with a wide door and a bathroom equipped with grab bars and shower without base.
<br/><br/>
The double rooms are located on two floors, overlooking San Gimignano or the surrounding countryside.
<br/><br/>
In the structure original staircases in travertine have been  preserved, as well as the brick floor of the hall, and the beautiful ceiling vaults. Where it was not possible to preserve the original elements, we tried to recreate the atmosphere of a time, by inserting handmade terracotta floors, exposed wooden beams and furnishing the rooms in rustic style with wrought iron beds and traditional furniture.
<br/><br/><br/><br/><br/><br/>
...
<img src="../_ext/img/best_agriturismo_in_tuscany_45.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
