...
{
    header("Location: http://m.casolaredibucciano.it/en/home_en.php");
    die();
}
if (($_SERVER["HTTP_HOST"]=="www.casolaredibucciano.it") or ($_SERVER["HTTP_HOST"]=="casolaredibucciano.it")) {
	header("HTTP/1.1 301 Moved Permanently"); 
header("Location: http://www.casolaredibucciano.eu/en/romantic-accommodation-san-gimignano.php");
...
<script src="../_ext/js/datetimepicker_css_en.js" type="text/javascript"></script>
...
<div id="header_1" style="background-image:url(../_ext/img/romantic_accommodation_san_gimignano_10.jpg);">
...
<input type="hidden" name="conferma" id="conferma" value="http://www.casolaredibucciano.eu/en/conferma.php">
<input type="hidden" name="errore" id="errore" value="">
	<div style="display:none;"><input name="url123" type="text" id="url123" size="20" value=""></div>

<input type="hidden" name="l" value="eng" />
    
      <table width="100%">
		<tr>
          <td>Name &amp;<br/>Surname</td>
...
<option value="15" <?php if($_SESSION['n_bambini'] == 15) echo 'selected'; ?>>15</option>
    ...
    <tr></tr>
        ...
        <?php if($_SESSION['copia_mittente']==NULL)  { ?>  <input  type="checkbox" name="copia_mittente" id="copia_mittente" value="copia_si"/>&nbsp;&nbsp;Select to receive a copy of your request
        
                <?php } else { ?><input  type="checkbox" name="copia_mittente" id="copia_mittente" value="<?php echo $_SESSION['copia_mittente'];?>" checked />&nbsp;&nbsp;Select to receive a copy of your request
      ...
      <h4 style="text-align:center; font-size:14px; color:#000; margin:0; padding:0;">Request</h4>
...
Azienda Agricola Signano<br/>Località Racciano-Bucciano<br/>53037 San Gimignano (SI)<br/><br/>Phone +39 0577 940189<br/>Fax +39 0577-906956<br/><br/><a href="mailto:info@casolaredibucciano.com?subject=Richiesta inviata da www.casolaredibucciano.eu" title="<?php include('../_ext/include/alt.php'); ?>"><strong>info@casolaredibucciano.com</strong></a></p>

<p style="margin:0;  padding:0; text-align:center; margin-top:20px;">
<img src="../_ext/img/romantic_accommodation_san_gimignano_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
