...
header("Location: http://www.casolaredibucciano.eu/en/agriturismo-holidays-italy.php");
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_holidays_italy_10.jpg);">
...
<tr><td class="left"><?php echo ucfirst($prz['Sistemazione_en']);?></td><td class="center"><strong>€ <?php echo $prz['Prezzo'];?>,00</strong></td></tr>
<?php } } ?>
...
$titolo = $modNews['titolo_en'.$lang];
$testo = $modNews['descrizione_en'.$lang];
$foto1 = $modNews['foto'];
if($foto1 != ""){ 	
$path = "file/".$foto1; ?>
<?php 
...
<br/>
<?php /*
Ricordiamo inoltre la possibilità di aggiungere in alcune camere il terzo letto al prezzo di € 26,00 per bambini fino a 11 anni e di € 36,00 per gli adulti.
<br/><br/>
Le tariffe includono: prima colazione a buffet, biancheria e asciugamani.<br/><br/><br/>
We confirm the possibility  to add, in some rooms, the third bed at price of 26 euro for the child up to 11 years and 36 euro for the adults.
The prices include: breakfast buffet, lines and towels.<br/><br/>
*/ ?>

<strong>Request – Information</strong><br/><br/>

To have more informations about the availability you can:<ul>
<li>send a email to <a href="mailto:info@casolaredibucciano.com?subject=Richiesta inviata da www.casolaredibucciano.eu" style="color:#877F6C;"><strong>info@casolaredibucciano.com</strong></a></li>
<li>call to 0039 0577 940189</li>
<li>send a fax to 0039 0577 906 956</li></ul>
