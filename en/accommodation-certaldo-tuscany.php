...
header("Location: http://www.casolaredibucciano.eu/en/accommodation-certaldo-tuscany.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/accommodation_certaldo_tuscany_10.jpg);">
...
<?php include_once('../_ext/include/foto_gallery_dintorni.php'); ?>
</div>
...
<div id="dintorni">
Because of its central location, <strong><a href="farmhouse-san-gimignano-tuscany.php" title="<?php include('../_ext/include/alt.php'); ?>">San Gimignano</a></strong> is a perfect base for excursions throughout <strong>Tuscany</strong>. From here, in fact, you can easily reach several cities such as  <strong><a href="accommodation-near-siena-tuscany.php" title="<?php include('../_ext/include/alt.php'); ?>">Siena</a></strong>, <strong>Florence</strong>, <strong>Lucca</strong> and <strong>Pisa</strong>.<br/><br/>


Also we would like to suggest other routes perhaps less known, but no less interesting:<ul>


<li><a href="accommodation-colle-val-d-elsa-tuscany.php" title="<?php include('../_ext/include/alt.php'); ?>">Colle di Val d’Elsa</a>, Casole d’Elsa and <a href="accommodation-monteriggioni-tuscany.php" title="<?php include('../_ext/include/alt.php'); ?>">Monteriggioni</a></li>
<li>Certaldo and Castelfiorentino</li>
<li><a href="accommodation-volterra-tuscany.php" title="<?php include('../_ext/include/alt.php'); ?>">Volterra</a></li>
<li>Massa Marittima and San Galgano</li>
<li>The Val d’Orcia and the Crete Senesi</li>
<li>Radda, Gaiole and Castellina in Chianti</li>
</ul>
</div>
<br/><br/>
...
<img src="../_ext/img/accommodation_certaldo_tuscany_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
