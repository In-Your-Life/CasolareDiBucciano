...
header("Location: http://www.casolaredibucciano.eu/en/accommodation-monteriggioni-tuscany.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/accommodation_monteriggioni_tuscany_10.jpg);">
...
<div id="titolo">
Surroundings &raquo; MONTERIGGIONI
</div>

<strong>Monteriggioni Castle</strong> was founded on a hill in early 1200 by the Sienese as an outpost to control the valley towards Florence, a historic rival of Siena. The medieval town is completely enclosed within the walls, which are organized for more than 500 metres and decorated with 14 towers. Only two doors will open, that of St. John facing Florence and Franca or Romea looking towards Siena. Since 2005 you can go on two stretches of the ancient walkways on the walls, from which you have beautiful views.
<br/><br/>
The village consists of a few alleys that wind around the central square, Piazza Roma, the heart of Monteriggioni. Unpaved, until about forty years ago, it is now finely paved. The square is still surrounded by vegetable gardens and gardens, which in the past ensured the survival in case of a siege.
...
<img src="../_ext/img/accommodation_monteriggioni_tuscany_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
