...
header("Location: http://www.casolaredibucciano.eu/en/agriturismo-pool-tuscany.php");
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_pool_tuscany_10.jpg);">
...
The farmhouse has a large swimming pool, with Jacuzzi from which you can enjoy the unique view of San Gimignano and the surrounding hills of Tuscany.
<br/><br/>
The Farm’s swimming pool is surrounded by a garden equipped with chairs, tables, sun beds and umbrellas, where you can spend the quiet afternoons relaxing.
...
<img src="../_ext/img/agriturismo_pool_tuscany_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
