...
{
  	header("Location: http://m.casolaredibucciano.it/en/ristorante_en.php");
   	die();
}
if (($_SERVER["HTTP_HOST"]=="www.casolaredibucciano.it") or ($_SERVER["HTTP_HOST"]=="casolaredibucciano.it")) {
	header("HTTP/1.1 301 Moved Permanently"); 
header("Location: http://www.casolaredibucciano.eu/en/agriturismo-with-restaurant-tuscany.php");
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_with_restaurant_tuscany_10.jpg);">
...
In the Farm’s restaurant you can taste the specialties of Tuscan cuisine: from ribollita to pappa al pomodoro, from braised veal to rabbit cooked in Vernaccia.
<br/><br/>
You'll also have the opportunity to taste our meats produced with pigs bred by us, a great ham, salami and tuscan mortadella, made with love and in absolute respect of the old traditions.
<br/><br/>
The menu varies with the changing seasons, always taking into account the seasonality of the products we use for our preparations.
<br/><br/>
Dinner is, of course, accompanied by our wines. The wide range of products of the Signano Farm  including Vernaccia di San Gimignano, Chianti Colli Senesi, San Gimignano Rosso, San Gimignano Vin Santo and the Rosé, can accompany any type of preparation and, not less importantly, meet every taste.
<br/><br/>
The dishes are prepared exclusively with the Extra-virgin olive oil we produce.
<br/><br/>
...
<img src="../_ext/img/agriturismo_with_restaurant_tuscany_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
