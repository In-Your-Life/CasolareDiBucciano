...
header("Location: http://www.casolaredibucciano.eu/en/production-grappa-italy.php");
...
<div id="header_1" style="background-image:url(../_ext/img/production_grappa_italy_10.jpg);">
...
<div id="home_sx" style="padding-bottom:50px;">

<div id="titolo">
The Farm &raquo; GRAPPA
</div>

Signano grappa is produced by distilling grape pomace from the  Vernaccia di San Gimignano.
<br/><br/>
...
<img src="../_ext/img/production_grappa_italy_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>"class="img_rounded" style="margin-top:15px;"/>
</p>
