...
header("Location: http://www.casolaredibucciano.eu/en/luxury-agriturismo-tuscany.php");
...
<div id="header_1" style="background-image:url(../_ext/img/luxury_agriturismo_tuscany_10.jpg);">
...
<div id="foto_gallery">
<strong>Outside</strong><br/><br/>

<?php $foto=getFoto(1); 
foreach ($foto as $key => $ft) {?>
	
<a href="<?php echo $ft['file'];?>" data-fancybox-group="gallery" class="fancybox" title="<?php echo $ft['didascalia_en'];?>">
<img src="<?php echo $ft['thumbnail'];?>" alt="<?php include_once('../_ext/include/alt.php'); ?>" class="img_rounded_gallery" style="border:none;" />
</a>
...
<img src="../_ext/gallery/luxury_agriturismo_tuscany_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
...
<script src="../it/jquery.spotslider.js"></script>
<script type="text/javascript">
$(document).ready(function() {
	newsSlider();
});
