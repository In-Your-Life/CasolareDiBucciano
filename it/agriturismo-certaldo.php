...
header("Location: http://www.casolaredibucciano.it/it/agriturismo-certaldo.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_certaldo_10.jpg);">
...
<div id="dintorni">
Per la sua collocazione centrale, <strong><a href="agriturismo-san-gimignano-toscana.php" title="<?php include('../_ext/include/alt.php'); ?>">San Gimignano</a></strong> è perfetto come base d’appoggio per escursioni in tutta la <strong>Toscana</strong>. Da qui, infatti, si possono raggiungere facilmente numerose città d’arte come <strong><a href="agriturismo-provincia-di-siena.php" title="<?php include('../_ext/include/alt.php'); ?>">Siena</a></strong>, <strong>Firenze</strong>, <strong>Lucca</strong> e <strong>Pisa</strong>.<br/><br/>
Inoltre vorremmo suggerirvi altri itinerari forse meno conosciuti, ma non per questo meno interessanti:<ul>
<li><a href="agriturismo-colle-val-d-elsa.php" title="<?php include('../_ext/include/alt.php'); ?>">Colle di Val d’Elsa</a>, Casole d’Elsa e <a href="agriturismo-monteriggioni.php" title="<?php include('../_ext/include/alt.php'); ?>">Monteriggioni</a></li>
<li>Certaldo e Castelfiorentino</li>
<li><a href="agriturismo-volterra-toscana.php" title="<?php include('../_ext/include/alt.php'); ?>">Volterra</a></li>
<li>Massa Marittima e San Galgano</li>
<li>La Val d’Orcia e le Crete Senesi</li>
<li>Radda, Gaiole e Castellina in Chianti</li>
</ul>
</div>
<br/><br/>
...
<img src="../_ext/img/agriturismo_certaldo_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
