...
header("Location: http://www.casolaredibucciano.it/it/agriturismo-piscina-toscana.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_piscina_toscana_10.jpg);">
...
<?php include_once('../_ext/include/foto_gallery_piscina.php'); ?>
</div>
...
L’<strong>Agriturismo</strong> è dotato di un’ampia <strong>piscina</strong>, con angolo idromassaggio dal quale potrete godere di una vista ineguagliabile su <strong>San Gimignano</strong> e le colline circostanti della <strong>Toscana</strong>.<br/><br/>

La <strong>piscina dell' agriturismo</strong> è contornata da un giardino attrezzato con sedie, tavoli, lettini prendisole ed ombrelloni, dove potrete trascorre dei tranquilli pomeriggi in completo relax. 
...
<img src="../_ext/img/agriturismo_piscina_toscana_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
