...
header("Location: http://www.casolaredibucciano.it/it/agriturismo-volterra-toscana.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_volterra_toscana_10.jpg);">
...
<?php include_once('../_ext/include/foto_gallery_volterra.php'); ?>
</div>
...
<div id="titolo">
I dintorni &raquo; VOLTERRA
</div>

Le origini di <strong>Volterra</strong> affondano le radici nella preistoria, ma il primo grande sviluppo si ha con gli Etruschi, che fanno di Velathri, Volterra, una delle città-stato più importanti della loro confederazione. Successivamente Velathri fu costretta a riconoscere la supremazia di Roma, cambiando il proprio nome in Volaterrae. Costruita su un colle di argilla, plasmato nei secoli da frane e smottamenti che hanno cancellato parte delle mura etrusche e della necropoli. <strong>Volterra</strong> vanta oltre 30 secoli di storia: dal neolitico a oggi, passando per gli Etruschi ed i Comuni. Il centro storico è interamente costruito con una pietra grigia chiamata panchina, ed è un integro esempio di abitato di età comunale.
<br/><br/>
Volterra si visita partendo da Piazza dei Priori, il cuore della città, dove si affacciano illustri edifici come il Palazzo Vescovile, il Palazzo Pretorio ed il Palazzo dei Priori. Nelle strade circostanti si incontrano varie case-torri ed il Duomo, il Battistero ed il Museo Civico. Dietro a quest’ultimo, a ridosso delle mura, vi è la parte romana con l’anfiteatro, mentre le testimonianze etrusche sono raccolte principalmente nel Parco Archeologico e al Museo Etrusco Guarnacci.
<br/><br/>
Nei pressi si erge la Fortezza Medicea, che sovrasta la città. Edificata per scopi militari, è stata adibita sin dall'inizio a carcere, dagli oppositori dei Medici fino ad oggi.
<br/><br/> 
Da sempre il nome di <strong>Volterra</strong> è collegato alla lavorazione dell’alabastro, materiale resistente e dagli effetti opalescenti, scoperto dagli Etruschi ed usato per le urne cinerarie, ed ancora oggi lavorato dagli artigiani in piccole botteghe.
...
<img src="../_ext/img/agriturismo_volterra_toscana_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
