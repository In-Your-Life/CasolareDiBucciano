...
header("Location: http://www.casolaredibucciano.it/it/agriturismo-romantico-toscana.php"); 
...
<?php include_once('../_ext/include/foto_gallery_gallery.php'); ?>
</div>
...
<a href="<?php echo $ft['file'];?>" data-fancybox-group="gallery" class="fancybox" title="<?php echo $ft['didascalia'];?>">
