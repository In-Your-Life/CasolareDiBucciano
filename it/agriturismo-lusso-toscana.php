...
{
  	header("Location: http://m.casolaredibucciano.it/it/agriturismo.php");
   	die();
}
if (($_SERVER["HTTP_HOST"]=="www.casolaredibucciano.eu") or ($_SERVER["HTTP_HOST"]=="casolaredibucciano.eu")) {
	header("HTTP/1.1 301 Moved Permanently"); 
header("Location: http://www.casolaredibucciano.it/it/agriturismo-lusso-toscana.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_lusso_toscana_100.jpg);">
...
<div id="titolo">
Agriturismo &raquo; LE CAMERE
</div>

L’<strong>Agriturismo</strong> è dotato di 11 <strong>camere</strong> con bagno, le stanze sono provviste di aria condizionata e riscaldamento indipendente, tv led e frigo.<br/><br/>
La J-suite è stata ricavata da un ampio fienile, dispone di un giardino privato e di una zona soggiorno con divano e caminetto. È la soluzione ideale per chi vuole un po’ di intimità o per chi, in inverno, cerca un luogo accogliente e caldo. <br/><br/>
La camera tripla è situata a piano terra, ed ha un piccolo giardino privato con ingresso indipendente.<br/><br/>
A piano terra abbiamo anche una camera doppia accessibile per disabili, con porta ampia e bagno attrezzato con maniglioni e doccia senza piatto.<br/><br/>
Le camere doppie sono disposte su due piani, con vista su <strong>San Gimignano</strong> oppure sulla campagna circostante. <br/><br/>
Nella struttura sono state conservate le scale originali in travertino, così come la pavimentazione in cotto della sala, ed il bellissimo soffitto con volte a vela. Dove non è stato possibile conservare gli elementi originali, abbiamo cercato di ricreare le atmosfere di un tempo, inserendo pavimenti in cotto fatto a mano, travi in legno a vista ed arredando gli ambienti in stile rustico con letti in ferro battuto e mobili di arte povera.<br/><br/>
...
<img src="../_ext/img/agriturismo_lusso_toscana_45.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
