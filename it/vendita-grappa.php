...
header("Location: http://www.casolaredibucciano.it/it/vendita-grappa.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/vendita_grappa_10.jpg);">
...
<?php include_once('../_ext/include/foto_gallery_grappa.php'); ?>
</div>
...
<div id="titolo">
Azienda agricola &raquo; LA GRAPPA
</div>

La <strong>grappa Signano</strong> è prodotta mediante la distillazione di vinacce provenienti da uve <strong>Vernaccia di San Gimignano</strong>.<br/><br/>

Le vinacce vengono inviate alla distilleria entro tre giorni dalla raccolta per mantenere e catturare tutti i profumi che vanno poi a comporre il bouquet aromatico della grappa stessa.<br/><br/>
...
<img src="../_ext/img/vendita_grappa_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>"class="img_rounded" style="margin-top:15px;"/>
</p>
