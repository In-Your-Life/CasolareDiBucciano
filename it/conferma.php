...
header("Location: http://www.casolaredibucciano.it/it/conferma.php"); 
...
<p style="font-size:24px; text-align:center; font-weight:bold; margin-top:80px;">
La tua richiesta è stata inviata correttamente.<br/><br/>
