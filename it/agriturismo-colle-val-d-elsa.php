...
header("Location: http://www.casolaredibucciano.it/it/agriturismo-colle-val-d-elsa.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_colle_val_d_elsa_10.jpg);">
...
<?php include_once('../_ext/include/foto_gallery_colle.php'); ?>
</div>
...
<div id="titolo">
I dintorni &raquo; COLLE VAL D'ELSA
</div>

<strong>Colle di Val d’Elsa</strong> è situata nel centro della <strong>Toscana</strong>, tra <strong>Siena</strong>, <strong>Firenze</strong> e <strong>Volterra</strong> ed a soli 13 km da <strong>San Gimignano</strong>, sul percorso della via Francigena. Troviamo vari documenti che attestano la presenza della cittadina dal X secolo, anche se acquista maggiore importanza solamente agli inizi del 1300, quando, sotto Firenze, fu utilizzata in contrapposizione alla senese Monteriggioni. Negli anni successivi la città continua ad acquisire potere, continuando a stare dalla parte della famiglia dei Medici.<br/>

Da sempre la storia e l’economia di Colle sono indissolubilmente legate alle acque del fiume Elsa, che permisero lo sviluppo di attività produttive come le cartiere, le manifatture laniere ed infine i laboratori del vetro e più tardi del cristallo. Già nell’Ottocento fu definita “la Boemia d’Italia”, mentre oggi è diventata “Città del Cristallo”, detenendo il 15% della produzione mondiale, ed oltre il 95% di quella italiana.<br/><br/>
La parte più interessante è senz’altro quella di Colle Alta, arroccata su un’altura e chiusa da una cerchia muraria ancora parzialmente visibile. Passeggiando per le vie di Colle Alta ci si può imbattere in vari edifici di interesse quali il Palazzo Pretorio, sede del Museo Archeologico Bianchi Bandinelli, il Duomo ed il Palazzo dei Priori, adibito a Museo Civico e d’Arte Sacra. Inoltre Colle vanta numerose case-torri, tra cui, la più famosa, è senz’altro quella di Arnolfo di Cambio, celebre scultore ed architetto del luogo. 
...
<img src="../_ext/img/agriturismo_colle_val_d_elsa_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
