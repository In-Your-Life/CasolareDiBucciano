...
header("Location: http://www.casolaredibucciano.it/it/agriturismo-monteriggioni.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_monteriggioni_10.jpg);">
...
<?php include_once('../_ext/include/foto_gallery_monteriggioni.php'); ?>
</div>
...
<div id="titolo">
I dintorni &raquo; MONTERIGGIONI
</div>

Il <strong>Castello di Monteriggioni</strong> fu fondato su un colle agli inizi del 1200 ad opera dei senesi, come avamposto per controllare le valli in direzione di Firenze, storica rivale di Siena.
Il borgo medievale è completamente racchiuso tra le mura, che si articolano per più di 500 m ed ornate da 14 torri. Solo due porte vi si aprono, quella di San Giovanni rivolta verso Firenze e quella Franca o Romea che guarda verso Siena. Dal 2005 è possibile percorrere due tratti degli antichi camminamenti di ronda sulle mura, dai quali si godono bellissimi panorami.<br/><br/>

Il borgo è costituito da pochi vicoli che si snodano attorno alla piazza centrale, Piazza Roma, il vero cuore di <strong>Monteriggioni</strong>. Sterrata, ovvero senza pavimentazione, fino ad una quarantina di anni fa, è ora finemente lastricata. La piazza è ancora circondata da orti e giardini, che in passato garantivano la sopravvivenza in caso di assedio.
...
<img src="../_ext/img/agriturismo_monteriggioni_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
