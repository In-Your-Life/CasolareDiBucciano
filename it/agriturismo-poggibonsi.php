...
header("Location: http://www.casolaredibucciano.it/it/agriturismo-poggibonsi.php"); 
...
<div id="header_1" style="background-image:url(../_ext/img/agriturismo_poggibonsi_10.jpg);">
...
<?php include_once('../_ext/include/foto_gallery_dove.php'); ?>
</div>
...
<strong>Da nord:</strong><br/>
Prendere l’autostrada A1 in direzione sud ed uscire a Firenze Impruneta. Dalla rotonda, prendere la superstrada Firenze-Siena in direzione Siena ed uscire a Poggibonsi Nord. Seguire le indicazioni per San Gimignano per circa 11 km e, una volta arrivati alla rotonda d’ingresso di San Gimignano, svoltare a sinistra in direzione Volterra, Castelsangimignano, Racciano. Proseguire sulla strada provinciale SP47 per circa 2 km. Svoltare a sinistra in corrispondenza del cartello Pescille – Il Casolare di Bucciano.
<br/><br/>
<strong>Da sud:</strong><br/>
Prendere l’autostrada A1 in direzione nord ed uscire a Valdichiana. Seguire le indicazioni per Siena. Da lì imboccare la superstrada Siena-Firenze in direzione Firenze. Uscire a Colle di val d’Elsa Sud oppure a Poggibonsi Nord e seguire le indicazioni per San Gimignano. Una volta arrivati alla rotonda d’ingresso di San Gimignano, svoltare a sinistra in direzione Volterra, Castelsangimignano, Racciano. Proseguire sulla strada provinciale SP47 per circa 2 km. Svoltare a sinistra in corrispondenza del cartello Pescille – Il Casolare di Bucciano.
<br/><br/>

<script type="text/javascript" src="../_ext/js/iframe_mappa.js"></script><br/>
...
<img src="../_ext/img/agriturismo_poggibonsi_40.jpg" alt="<?php include('../_ext/include/alt.php'); ?>" class="img_rounded"/>
</p>
</div>
