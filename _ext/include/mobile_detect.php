<?php
/*
DA INSERIRE NELLE PAGINE INDEX
...
if ($_SERVER["HTTP_HOST"]=="www.numero8florence.com" || $_SERVER["HTTP_HOST"]=="numero8florence.com") 
{
    header("Location: http://m.numero8firenze.it/?l=_eng");
    die();
}
else
{
    header("Location: http://m.numero8firenze.it");
    die();
}
}
*/
